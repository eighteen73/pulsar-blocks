...
/* harmony import */ var embla_carousel_fade__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! embla-carousel-fade */ "./node_modules/embla-carousel-fade/esm/embla-carousel-fade.esm.js");
...
/* harmony import */ var embla_carousel_auto_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! embla-carousel-auto-scroll */ "./node_modules/embla-carousel-auto-scroll/esm/embla-carousel-auto-scroll.esm.js");
/* harmony import */ var _utils_embla__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/embla */ "./src/utils/embla.js");
...
document.addEventListener('DOMContentLoaded', () => {
  const carouselBlocks = document.querySelectorAll('.wp-block-pulsar-embla-carousel');
  carouselBlocks.forEach(carouselBlock => {
    ...
    const autoplayOptions = JSON.parse(emblaNode.dataset.emblaAutoplayOptions);
    const autoscroll = emblaNode.dataset.emblaAutoscroll === 'true';
    const autoscrollOptions = JSON.parse(emblaNode.dataset.emblaAutoscrollOptions);
    const viewportNode = emblaNode.querySelector('.embla__viewport');
    const prevBtnNode = emblaNode.querySelector('.embla__button--prev');
    const nextBtnNode = emblaNode.querySelector('.embla__button--next');
    const dotsNode = emblaNode.querySelector('.embla__dots');
    const containerNode = emblaNode.querySelector('.embla__container');
    const queryLoop = containerNode.querySelector('.wp-block-post-template') || emblaNode.querySelector('.wp-block-woocommerce-product-template');
    const progressNode = emblaNode.querySelector('.embla__progress__bar');
    const plugins = [(0,embla_carousel_class_names__WEBPACK_IMPORTED_MODULE_1__["default"])()];
    if (fade) {
      plugins.push((0,embla_carousel_fade__WEBPACK_IMPORTED_MODULE_2__["default"])());
    }
    if (autoplay) {
      plugins.push((0,embla_carousel_autoplay__WEBPACK_IMPORTED_MODULE_3__["default"])(autoplayOptions));
      options.loop = true;
    }
    if (autoscroll) {
      plugins.push((0,embla_carousel_auto_scroll__WEBPACK_IMPORTED_MODULE_4__["default"])(autoscrollOptions));
    }
    if (queryLoop !== null) {
    ...
    const emblaApi = (0,embla_carousel__WEBPACK_IMPORTED_MODULE_5__["default"])(viewportNode, options, plugins);
    ...
    if (progressNode) {
      const {
        applyProgress,
        removeProgress
      } = (0,_utils_embla__WEBPACK_IMPORTED_MODULE_0__.setupProgressBar)(emblaApi, progressNode);
