...
window.addEventListener('DOMContentLoaded', () => {
  ...
  blocks.forEach(block => {
    ...
    const lightbox = (0,lightgallery__WEBPACK_IMPORTED_MODULE_0__["default"])(block, {
      download: false,
      allowMediaOverlap: false,
      mobileSettings: {
        showCloseIcon: true
      ...
      plugins: showThumbnails ? [lightgallery_plugins_thumbnail__WEBPACK_IMPORTED_MODULE_1__["default"]] : []
    });
    if (overlayColor) {
      const container = lightbox.$container.selector;
      container.style.setProperty('--lightbox-overlay-color', overlayColor);
    }
    const viewAll = block.querySelector('.wp-block-pulsar-media-viewer__view-all');
