...
function Edit(_ref) {
  ...
  const addBlock = () => {
    ...
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)("core/editor").insertBlock(block, innerBlocks.length, clientId).then(() => {
      refreshCarousel();
  ...
  const callback = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(() => {
    console.log("hello");
    refreshCarousel();
  });
